...
// navigating away; the chapter itself scrolls inside the card. The cited
// verse(s) stay highlighted, and Prev/Next lets the reader keep going
// through the book from there.

    ...
    <Modal visible={visible} animationType="fade" transparent onRequestClose={onClose}>
      <TouchableOpacity style={styles.backdrop} activeOpacity={1} onPress={onClose}>
        <TouchableOpacity activeOpacity={1} style={styles.card} onPress={() => {}}>
          ...
          <TouchableOpacity style={styles.item} onPress={() => handle(onBibleReadingPlans)} accessibilityRole="button">
            <Ionicons name="calendar-outline" size={18} color={colors.sageDark} />
            <Text style={styles.itemLabel}>{t("bibleReadingPlans.title")}</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.item} onPress={() => handle(onPrayerList)} accessibilityRole="button">
            <Ionicons name="hand-left-outline" size={18} color={colors.sageDark} />
            <Text style={styles.itemLabel}>{t("prayerList.title")}</Text>
          </TouchableOpacity>
